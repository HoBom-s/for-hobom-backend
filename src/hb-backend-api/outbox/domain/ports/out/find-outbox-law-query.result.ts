...
import { LawChangedPayload } from "../../model/law-changed.payload";

export class FindOutboxLawQueryResult {
  constructor(
    private readonly id: OutboxId,
    private readonly eventId: string,
    private readonly eventType: EventType,
    private readonly payload: LawChangedPayload,
  ...
  public static from(params: FindOutboxEntity) {
    return new FindOutboxLawQueryResult(
      params.getId,
      params.getEventId,
      params.getEventType,
      params.getPayload as LawChangedPayload,
      params.getStatus,
  ...
  public get getPayload(): LawChangedPayload {
    return this.payload;
  }
