...
import { UserSchema } from "./domain/model/user.schema";
...
import { CreateUserController } from "./adapters/in/create-user.controller";
import { UserQueryAdapter } from "./adapters/out/user-query.adapter";
